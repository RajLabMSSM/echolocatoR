...
CORCES_2020.get_scATAC_peak_overlap <- function(finemap_dat,
                                                FDR_filter=NULL,
                                                add_cicero=T,
                                                verbose=T){
...
#' dat_melt <- CORCES_2020.prepare_peak_overlap(merged_DT=merged_DT)
CORCES_2020.prepare_peak_overlap <- function(merged_DT,
                                             FDR_filter=NULL,
  ...
  gr.hits <- CORCES_2020.get_scATAC_peak_overlap(finemap_dat = finemap_dat,

...
#'
#' Currently removes header and saves it as  \emph{header.txt}
#' in the same directory as the file it came from.
#'
#' @family query functions
#' @param remove_header Remove the header to avoid errors when sorting/converting to tabix forrmat.
#' @inheritParams finemap_pipeline
TABIX.convert_file <- function(fullSS_path,
                               chrom_col="CHR",
                               position_col="POS",
                               remove_header=T){
  # fullSS_path="./Data/GWAS/Nalls23andMe_2019/nallsEtAl2019_allSamples_allVariants.mod.txt",fullSS_path="./Data/GWAS/Nalls23andMe_2019/nallsEtAl2019_allSamples_allVariants.mod.txt"
...
#' Query a tabix file
#'
#' Query by min/max genomic coordinates.
#'
#' @family query functions

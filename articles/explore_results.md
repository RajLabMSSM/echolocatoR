...
Top 10 SNPs by mean posterior probability {.table style="width:100%;"}
...
Consensus fine-mapped SNPs (BST1 locus) {.table style="width:100%;"}
...
SNP counts by support level {.table}
...
Number of SNPs in credible sets per method {.table}
...
Summary across bundled loci {.table}

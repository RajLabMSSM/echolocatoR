...
```
    ...
    ## [1] rworkflows_1.0.8 rmarkdown_2.30
    ##
    ...
    ##  [17] OrganismDbi_1.53.2          ensembldb_2.35.0
    ##  [19] lattice_0.22-9              MASS_7.3-65
    ##  [21] backports_1.5.0             magrittr_2.0.4
    ##  [23] Hmisc_5.2-5                 openxlsx_4.2.8.1
    ##  [25] yaml_2.3.12                 dlstats_0.1.7
    ##  [27] otel_0.2.0                  zip_2.3.3
    ##  [29] ggbio_1.59.0                reticulate_1.45.0
    ##  [31] gld_2.6.8                   DBI_1.3.0
    ##  [33] RColorBrewer_1.1-3          abind_1.4-8
    ##  [35] expm_1.0-0                  rvcheck_0.2.1
    ##  [37] GenomicRanges_1.63.1        purrr_1.2.1
    ##  [39] R.utils_2.13.0              AnnotationFilter_1.35.0
    ##  [41] biovizBase_1.59.0           BiocGenerics_0.57.0
    ##  [43] RCurl_1.98-1.17             nnet_7.3-20
    ##  [45] yulab.utils_0.2.4           VariantAnnotation_1.57.1
    ##  [47] rappdirs_0.3.4              IRanges_2.45.0
    ##  [49] S4Vectors_0.49.0            echoLD_1.0.0
    ##  [51] echofinemap_1.0.0           irlba_2.3.7
    ##  [53] gitcreds_0.1.2              echodata_1.0.0
    ...
    ##  [73] survival_3.8-6              tools_4.6.0
    ##  [75] DescTools_0.99.60           Rcpp_1.1.1
    ##  [77] glue_1.8.0                  gridExtra_2.3
    ##  [79] SparseArray_1.11.11         xfun_0.56
    ##  [81] here_1.0.2                  MatrixGenerics_1.23.0
    ##  [83] GenomeInfoDb_1.47.2         dplyr_1.2.0
    ##  [85] withr_3.0.2                 BiocManager_1.30.27
    ##  [87] fastmap_1.2.0               basilisk_1.23.0
    ##  [89] boot_1.3-32                 digest_0.6.39
    ##  [91] R6_2.6.1                    colorspace_2.1-2
    ##  [93] dichromat_2.0-0.1           RSQLite_2.4.6
    ##  [95] cigarillo_1.1.0             R.methodsS3_1.8.2
    ##  [97] tidyr_1.3.2                 generics_0.1.4
    ##  [99] renv_1.1.8                  data.table_1.18.2.1
    ## [101] rtracklayer_1.71.3          class_7.3-23
    ## [103] httr_1.4.8                  htmlwidgets_1.6.4
    ## [105] S4Arrays_1.11.1             pkgconfig_2.0.3
    ## [107] gtable_0.3.6                Exact_3.3
    ## [109] blob_1.3.0                  S7_0.2.1
    ## [111] XVector_0.51.0              echoconda_1.0.0
    ## [113] htmltools_0.5.9             susieR_0.14.2
    ## [115] RBGL_1.87.0                 ProtGenerics_1.43.0
    ## [117] scales_1.4.0                Biobase_2.71.0
    ## [119] lmom_3.2                    png_0.1-8
    ## [121] knitr_1.51                  rstudioapi_0.18.0
    ## [123] reshape2_1.4.5              tzdb_0.5.0
    ## [125] rjson_0.2.23                checkmate_2.3.4
    ## [127] badger_0.2.5                curl_7.0.0
    ## [129] proxy_0.4-29                cachem_1.1.0
    ## [131] stringr_1.6.0               rootSolve_1.8.2.4
    ## [133] parallel_4.6.0              foreign_0.8-91
    ## [135] AnnotationDbi_1.73.0        restfulr_0.0.16
    ## [137] desc_1.4.3                  pillar_1.11.1
    ## [139] grid_4.6.0                  reshape_0.8.10
    ## [141] vctrs_0.7.1                 cluster_2.1.8.2
    ## [143] htmlTable_2.4.3             evaluate_1.0.5
    ## [145] readr_2.2.0                 GenomicFeatures_1.63.1
    ## [147] mvtnorm_1.3-5               cli_3.6.5
    ## [149] compiler_4.6.0              echogithub_1.0.0
    ## [151] Rsamtools_2.27.1            rlang_1.1.7
    ## [153] crayon_1.5.3                aws.signature_0.6.0
    ## [155] forcats_1.0.1               plyr_1.8.9
    ## [157] fs_1.6.7                    stringi_1.8.7
    ## [159] coloc_5.2.3                 echoannot_1.0.1
    ## [161] viridisLite_0.4.3           BiocParallel_1.45.0
    ## [163] Biostrings_2.79.5           lazyeval_0.2.2
    ## [165] gh_1.5.0                    Matrix_1.7-4
    ## [167] downloadR_1.0.0             dir.expiry_1.19.0
    ## [169] BSgenome_1.79.1             patchwork_1.3.2
    ## [171] hms_1.1.4                   bit64_4.6.0-1
    ## [173] ggplot2_4.0.2               KEGGREST_1.51.1
    ## [175] haven_2.5.5                 SummarizedExperiment_1.41.1
    ## [177] memoise_2.0.1               snpStats_1.61.1
    ## [179] bit_4.6.0                   readxl_1.4.5

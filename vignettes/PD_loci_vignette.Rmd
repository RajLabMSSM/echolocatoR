...
LRRK2 <- echoplot::plot_locus(finemap_dat=fread(data_dict$finemap[[locus]]),   
...
MBNL2 <- echoplot::plot_locus(finemap_dat=fread(data_dict$finemap[[locus]]),   
                    LD_matrix=fread(data_dict$LD[[locus]]),
                    LD_reference="UKB",
                    locus_dir=data_dict$locus_dir[[locus]], 
...
DYRK1A <- echoplot::plot_locus(finemap_dat=fread(data_dict$finemap[[locus]]),   
                    LD_matrix=fread(data_dict$LD[[locus]]),
                    LD_reference="UKB",
                    locus_dir=data_dict$locus_dir[[locus]], 
...
FCGR2A <- echoplot::plot_locus(finemap_dat=fread(data_dict$finemap[[locus]]),   
                    LD_matrix=fread(data_dict$LD[[locus]]),
                    LD_reference="UKB",
                    locus_dir=data_dict$locus_dir[[locus]], 

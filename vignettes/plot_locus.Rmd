...
```{r trk_plot.QTL}
qtl_dat <- data.table::copy(dat)
# Make fake QTL P-values for the sake a demonstration
qtl_dat$fake_eQTL.P <- abs(jitter(qtl_dat$P, amount = 1e-15))
qtl_dat$fake_sQTL.P <- abs(jitter(qtl_dat$P, amount = 1e-16))

trk_plot.qtl <- echoplot::plot_locus(dat = qtl_dat, 
                                     LD_matrix = LD_matrix, 
                                     LD_reference = LD_reference,
                                     locus_dir = locus_dir,
                                     zoom = "10x",

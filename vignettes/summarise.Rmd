...
```{r get_SNPgroup_counts(), eval=has_internet}
...
```{r get_CS_counts(), eval=has_internet}
...
```{r super_summary_plot(), fig.height=10, fig.width=10, eval=has_internet}
...
- Explore individual locus results: `vignette("explore_results")`

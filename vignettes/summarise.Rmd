...
<!-- Pre-render to reduce vignette runtime  -->
<!-- ```r -->
<!-- ggplot2::ggsave("~/Downloads/super_plot.png",super_plot$plot, height = 15, width = 15) -->
<!-- ``` -->
<!-- ![super_plot](https://github.com/RajLabMSSM/echolocatoR/raw/master/images/super_plot.png) -->
